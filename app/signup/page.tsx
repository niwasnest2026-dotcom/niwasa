...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to the original page with sharing type if available
      if (redirectPath && sharingType) {
        const propertyId = redirectPath.split('/').pop();
        router.push(`/payment?propertyId=${propertyId}&sharingType=${encodeURIComponent(sharingType)}`);
